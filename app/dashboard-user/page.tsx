        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Anang Kurniawan</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="relative" data-dropdown>
              <button
                ...
                className="p-2.5 hover:bg-white rounded-full transition-colors border-2 border-transparent hover:border-black"
              >
                <svg className="h-6 w-6 text-gray-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-50">
                  <div className="p-4 border-b-2 border-black">
                    <p className="text-sm font-semibold text-gray-900">Anang Kurniawan</p>
                    <p className="text-xs text-gray-500">anang@example.com</p>
                  </div>
                  <div className="p-2">
